...
-- --------------------------------------------------
-- Date Created: 03/17/2014 09:12:40
...
IF OBJECT_ID(N'[dbo].[FK_RoleMenu_Menu]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[RoleMenus] DROP CONSTRAINT [FK_RoleMenu_Menu];
GO
IF OBJECT_ID(N'[dbo].[FK_RoleMenu_Role]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[RoleMenus] DROP CONSTRAINT [FK_RoleMenu_Role];
GO
...
-- Creating primary key on [Id] in table 'RoleMenus'
...
-- Creating foreign key on [MenuId] in table 'RoleMenus'
ALTER TABLE [dbo].[RoleMenus]
...
-- Creating foreign key on [RoleId] in table 'RoleMenus'
ALTER TABLE [dbo].[RoleMenus]
